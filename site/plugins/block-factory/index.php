...
Kirby::plugin('rare-beast/block-factory', [
    'blueprints' => [
        ...
        'blocks/single-image' => __DIR__ . '/blueprints/blocks/single-image.yml',
    ...
    'snippets' => [
        ...
        'blocks/single-image' => __DIR__ . '/snippets/blocks/single-image.php',
    ...
    'translations' => [
        'en' => [
            ...
            'field.blocks.single-image' => 'Single Image',
